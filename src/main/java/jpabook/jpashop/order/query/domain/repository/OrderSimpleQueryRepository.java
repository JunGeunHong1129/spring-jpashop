...
import jpabook.jpashop.order.query.domain.dto.SimpleOrderDTO;
...
public class OrderSimpleQueryRepository {
    ...
    public List<SimpleOrderDTO> findOrderDTOs(){
        return em.createQuery("select new jpabook.jpashop.order.query.domain.dto.SimpleOrderDTO(o.id,o.orderDate,m.name,o.orderStatus,d.address) " +
                "from Order o " +
                "join o.member m " +
